...
for k1 = 1:length(c_set)
    heatmap_performance(mean(totalRset{k1},3),length(a_posiprop_set),[tmp_max tmp_min],['Figure13' tmp_letters{k1}]);
end
...
save data_SRIRex_Figure13CD Out_set
%
for k1 = 1:2
    F = figure;
    A = axes;
    ...
    print(F,'-depsc',['Figure13C' num2str(k1)]);
end
%
...
for k1 = 1:2
    ...
    print(F,'-depsc',['Figure13D-' tmp_letters(k1)]);
end
