...
save data_figure12Bright totalRset
heatmap_performance(mean(totalRset,3),length(a_posiprop_set),[],'Figure12Bright');
...
save data_figure12Cright totalRset
heatmap_performance(mean(totalRset,3),length(a_posiprop_set),[],'Figure12Cright');
...
save data_figure12E-G totalRset
% top images
tmp_letters = 'EFG';
for k_model = 1:3
...
for k_model = 1:3
    ...
    print(F,'-depsc',['Figure12' tmp_letters(k_model) 'bottom']);
end
